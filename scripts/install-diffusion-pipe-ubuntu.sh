...
echo "  PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True NCCL_P2P_DISABLE=1 NCCL_IB_DISABLE=1 .venv/bin/deepspeed --num_gpus=1 train.py --deepspeed --config $CONFIG_DIR/anima-lora.toml"
